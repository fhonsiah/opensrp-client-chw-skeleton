...
public class BaseTBLeprosyContactVisitActivity extends SecuredActivity implements BaseTBLeprosyVisitContract.View, View.OnClickListener {

    private static final String TAG = BaseTBLeprosyContactVisitActivity.class.getCanonicalName();
    ...
    public static void startMe(Activity activity, String baseEntityID, Boolean isEditMode) {
        Intent intent = new Intent(activity, BaseTBLeprosyContactVisitActivity.class);
    ...
    public void onBackPressed() {
        displayExitDialog(BaseTBLeprosyContactVisitActivity.this::finish);
    }
